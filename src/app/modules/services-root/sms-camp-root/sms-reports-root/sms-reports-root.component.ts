...
@Component({
  selector: 'app-sms-reports-root',
  templateUrl: './sms-reports-root.component.html',
  styleUrls: ['./sms-reports-root.component.scss'],
  encapsulation: ViewEncapsulation.None,
  host: { class: 'full-height' },
})
export class SMSReportsRootComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public missedChartSectionService: JctsmsReportService,
  ...
  goTodetailReport() {
    this.router.navigate(['landing/services/sms-report/reports-details']);
  }
  ...
  smsSendTime() {
    ...
    this.missedChartSectionService.smsSendTime(payload).subscribe((res: any) => {
      this.smsTime = res.result;
    })
  }
  missedSummary() {
    let payload: any = {
      campaignId: this.selectedCampaign?.campaignId,
      // campaignId: 'aac16cfa029625b0a6e90d1c001af7f9',
