...
@Component({
  selector: 'app-missed-reports-details',
  templateUrl: './missed-reports-details.component.html',
  styleUrls: ['./missed-reports-details.component.scss'],
  encapsulation: ViewEncapsulation.None,
  host: { 'class': 'full-height' }
})
export class MissedReportsDetailsComponent implements OnInit {
  ...
  constructor(private router: Router, private missedChartSectionService: JctmissedReportService, public toastservice: ToastService) { }
  ...
  goBacktoReportList() {
    this.router.navigateByUrl('/landing/services/reports-landing');
  }
